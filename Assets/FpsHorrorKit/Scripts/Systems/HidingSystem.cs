namespace FpsHorrorKit
{
    ...
    public class HidingSystem : MonoBehaviour, IInteractable
    {
        ...
        [SerializeField][Tooltip("The rotation angle of the door")] private float endRotation;
        [SerializeField][Tooltip("This variable should be the same as the camera transition speed")] private float hidingSpeed = 1f;
        [SerializeField][Tooltip("The speed at which the door rotates around its hinge")] private float rotationSpeed = 100f;
