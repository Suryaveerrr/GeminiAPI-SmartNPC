...
public class FpsController : MonoBehaviour
{
    ...
    // This is now redundant but we'll leave it for compatibility with other scripts if needed.
    ...
    {
        // --- THE FIX ---
        // If the game is not in Gameplay mode, do nothing.
        if (GameManager.Instance.CurrentGameState != GameState.Gameplay)
        {
            // Reset velocity to stop sliding when dialogue opens.
            velocity.x = 0;
            velocity.z = 0;
            return;
        }
    ...
    {
        // --- THE FIX ---
        // If the game is not in Gameplay mode, do not process camera rotation.
